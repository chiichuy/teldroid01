...
public class Lab05AQueryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lab05_aquery);
	...
	public void asyncJson() {
		...
		String url = "https://graph.facebook.com/angelofdeathv1";
	...
	public void jsonCallback(String url, JSONObject json, AjaxStatus status) {
		...
		if (json != null) {
			try {
				...
				aq.id(R.id.imagen)
						.progress(pd)
						.image("https://graph.facebook.com/" + id
								+ "/picture?type=large");
	...
	public void cargarContactos(String url, XmlDom xml, AjaxStatus status) {
		...
		for (XmlDom contacto : contactos) {
			...
			// imageUrl = entry.tag("content", "type",
			// "image/jpeg").attr("src");
		}
